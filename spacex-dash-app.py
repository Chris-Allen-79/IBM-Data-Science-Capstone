...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='class',
        title='Launch Outcomes at ' + entered_site)
        return fig
...
def get_scatter_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.scatter(filtered_df4,x=filtered_df4['Payload Mass (kg)'], y=filtered_df4['class'], color='Booster Version Category',
        title='Launch Outcome by Payload Mass at ' + entered_site)
        return fig
